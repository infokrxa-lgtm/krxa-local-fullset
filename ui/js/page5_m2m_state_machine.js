/* page5_m2m_state_machine.js - TRAVEL_V1_AI_DIALOGUE_FULL_SET_V4C */
(function(){
  if(window.KRXA_PAGE5_M2M_STATE_V4C_LOADED){return;}
  window.KRXA_PAGE5_M2M_STATE_V4C_LOADED=true;
  ...
  function setStatus(msg){
    try{
      ...
      nodes.forEach(function(n){
        var t=text(n).trim();
        if(t.length<120&&(t.indexOf("다음 말")>=0||t.indexOf("말하기 버튼")>=0||t.indexOf("AI대화")>=0||t.indexOf("음성")>=0||t.indexOf("STT")>=0||t.indexOf("통역")>=0)){
  ...
  function bindToggle(){
    var t=findAiToggle();
    if(t&&t.getAttribute("data-v4c-page5-bound")!=="1"){
      t.setAttribute("data-v4c-page5-bound","1");
  ...
  setInterval(function(){if(isPage5()){syncFromToggle();}},1000);
