/* page5_m2m_state_machine.js - TRAVEL_V1_AI_DIALOGUE_FULL_SET_V4D */
(function(){
  if(window.KRXA_PAGE5_M2M_STATE_V4D_LOADED){return;}
  window.KRXA_PAGE5_M2M_STATE_V4D_LOADED=true;
  ...
  function setMode(mode){mode=(mode==="ai"||mode==="ai_dialogue")?"ai_dialogue":"translate";state.mode=mode;window.KRXA_PAGE5_MODE=mode==="ai_dialogue"?"ai":"translate";window.KRXA_M2M_MODE=window.KRXA_PAGE5_MODE;window.KRXA_PAGE5_AI_DIALOGUE_ENABLED=mode==="ai_dialogue";window.KRXA_AI_DIALOGUE_ENABLED=mode==="ai_dialogue";window.KRXA_AI_DIALOGUE_FREE_MODE=mode==="ai_dialogue";visual(mode==="ai_dialogue");setStatus(mode==="ai_dialogue"?"AI대화 준비 완료 · 말하기를 눌러 시작하세요":"마이크를 누르면 통역을 시작합니다");return state.mode;}
  ...
  function bindToggle(){var el=toggleEl();if(el&&el.getAttribute("data-v4d-page5-bound")!=="1"){el.setAttribute("data-v4d-page5-bound","1");el.setAttribute("data-flow","page5.ai.toggle");el.removeAttribute("onclick");}}
