...
window.KRXA_App.openTravelInspiration = function () {
  if (window.KRXA_DeviceContext && window.KRXA_DeviceContext.openLocationSearch) {
    window.KRXA_DeviceContext.openLocationSearch(
      "tourist attractions experiences near me"
    );
    return;
  }
  ...
  window.open(
    "https://www.google.com/search?q=" +
      encodeURIComponent("nearby tourist attractions experiences"),
    "_blank"
  );
};
  ...
  window.KRXA_App.openTransport = function () {
    if (window.KRXA_App && window.KRXA_App.openModal) {
      window.KRXA_App.openModal(
        "교통 선택",
       "<button class='btn blue' style='width:100%;margin-top:8px' onclick=\"window.open(window.KRXA_DeviceContext.buildGoogleMapsSearchUrl('airport transportation near me'),'_blank')\">✈️ 항공 / 공항 이동</button>" +
"<button class='btn blue' style='width:100%;margin-top:8px' onclick=\"window.open(window.KRXA_DeviceContext.buildGoogleMapsSearchUrl('subway station near me'),'_blank')\">🚇 지하철</button>" +
"<button class='btn blue' style='width:100%;margin-top:8px' onclick=\"window.open(window.KRXA_DeviceContext.buildGoogleMapsSearchUrl('bus stop near me'),'_blank')\">🚌 버스</button>" +
"<button class='btn green' style='width:100%;margin-top:8px' onclick=\"window.open(window.KRXA_DeviceContext.buildGoogleMapsSearchUrl('taxi stand near me'),'_blank')\">🚕 택시</button>"
      );
      return;
    }
